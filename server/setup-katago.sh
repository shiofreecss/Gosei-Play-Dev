...
echo -e "boardsize 9\nclear_board\nquit" | timeout 10s ./katago gtp -model kata1-b6c96-s175395328-d26788732.txt -config ../engines/katago-cpu-config.cfg > /dev/null 2>&1
if [ $? -eq 0 ]; then
...
echo "   • Neural network: katago/kata1-b6c96-s175395328-d26788732.txt"
